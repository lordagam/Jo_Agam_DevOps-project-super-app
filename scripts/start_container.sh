...
docker run -d --name super-app-node -p 3000:3000 lordagam/joseph-agam-project-devops_node
docker run -d --name super-app-php -p 80:80 lordagam/joseph-agam-project-devops_php
